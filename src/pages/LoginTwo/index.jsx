  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-nunito items-center justify-start mx-auto w-full">
        ...
        <div className="bg-blue_gray-50 flex md:flex-col flex-row font-roboto md:gap-10 items-start justify-between p-[116px] md:px-10 sm:px-5 w-full">
          <div className="flex md:flex-1 flex-col gap-[49px] items-start justify-start md:mt-0 mt-[103px] w-[44%] md:w-full">
          ...
          <div className="bg-white-A700 border border-black-900_1f border-solid flex md:flex-1 flex-col gap-[26px] items-start justify-start mb-[188px] mr-[22px] md:px-5 px-[49px] py-12 rounded w-auto md:w-full">
            ...
            <Button
              ...
              onClick={() => navigate("/absenceapplicationone")}
              shape="round"
              color="indigo_A400"
              size="sm"
              variant="fill"
